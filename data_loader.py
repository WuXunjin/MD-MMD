...
def office31_loader(cfg, val=True):
    ...
    tar_loader = DataLoader(data_tar, batch_size=cfg.batch_size, shuffle=True, drop_last=True, num_workers=16, pin_memory=True)
    if val:
        ...
        train_loader = DataLoader(data_train, batch_size=cfg.batch_size, shuffle=True, drop_last=True, num_workers=16, pin_memory=True)
        val_loader   = DataLoader(data_val, batch_size=cfg.batch_size, shuffle=True, drop_last=True, num_workers=16, pin_memory=True)
        return train_loader, val_loader, tar_loader
    else:
        train_loader = DataLoader(data_src, batch_size=cfg.batch_size, shuffle=True, drop_last=True, num_workers=16, pin_memory=True)
